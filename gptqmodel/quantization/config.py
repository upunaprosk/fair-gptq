...
META_FIELD_LOG_HESSIAN_SENSITIVITIES = "log_hessian_sensitivity"

META_GRADIENT_UPDATE = "gradient_update"
...
class QuantizeConfig():
    ...
    # weather to perform gradient update during quantization for fairgptq
    gradient_update: bool = field(default=False)
