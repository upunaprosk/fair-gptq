...
class QuantizeConfig():
    ...
    # weather to use fairgptq style quantization, in this case the passed data should be minimal stereo pairs
    fairgptq: bool = field(default=False)
